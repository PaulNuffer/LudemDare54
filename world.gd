...
func wave_ended():
	...
	if(run_won):
		...
		$OpenDoor/OpenDoorArt.hide()
	else:
		$OpenDoor/FinalOpenDoorArt.hide()
		$OpenDoor/OpenDoorArt.show()
	$ClosedDoorArt.hide()
